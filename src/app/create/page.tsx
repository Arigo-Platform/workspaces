  ...
  return (
    <div>
      <section className="p-4 space-y-6">
        <h2 className="text-3xl font-bold dark:text-white text-blackA12 animate-slideLeftAndFade">
          Create an Arigo Workspace
        </h2>
        <h3 className="text-lg dark:text-white text-blackA12 animate-slideLeftAndFade">
          If you're looking to innovative your community, you're in the right
          place.
        </h3>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 animate-slideLeftAndFade">
          ...
          <Link href="/create" className="w-full h-full max-h-32">
            <div className="p-4 transition duration-100 bg-white border border-gray-600 rounded-md shadow-sm hover:bg-gray-100 dark:bg-blackA8 dark:hover:bg-zinc-900 dark:text-white dark:shadow-none ">
